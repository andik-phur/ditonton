...
// in nontonin_with_clean_arcitectur_and_test_driven_development_flutter/test/presentation/provider/tv_detail_notifier_test.dart.
...
class MockGetTvRecommendations extends _i1.Mock
  ...
  _i2.TvRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          ...
          as _i2.TvRepository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i9.Television>>> execute(
          dynamic id) =>
      (super.noSuchMethod(Invocation.method(#execute, [id]),
          returnValue:
              _i5.Future<_i3.Either<_i6.Failure, List<_i9.Television>>>.value(
                  _FakeEither_1<_i6.Failure, List<_i9.Television>>(
                      this, Invocation.method(#execute, [id])))) as _i5
          .Future<_i3.Either<_i6.Failure, List<_i9.Television>>>);
}
